...
globalThis.$altcha.i18n.set("en", i18n$Z);
...
var root$5 = /* @__PURE__ */ from_html(`<div><span class="altcha-logo" aria-hidden="true"><img src="/assets/friskydev-wolf-transparent.png" alt="" width="28" height="28" style="display:block;object-fit:contain;filter:invert(1);opacity:.82"></span></div>`);
function Logo($$anchor, $$props) {
  ...
  reset(div);
  template_effect(() => set_attribute(a, "aria-label", "FriskyDev"));
  append($$anchor, div);
  return pop($$exports);
}

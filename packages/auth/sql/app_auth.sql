-- Better Auth tables for Fenrir / Frisky app login.
-- Isolated from Community Gate fenrir_* tables. Apply on the same Neon
-- database that already holds the gate schema, or a dedicated app-auth DB.
--
-- Do not run this as a substitute for docs/neon-community-gate-schema.sql.

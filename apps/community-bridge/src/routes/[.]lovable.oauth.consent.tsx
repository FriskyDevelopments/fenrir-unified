      ...
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/[0.03] p-8 text-center backdrop-blur-xl">
        ...
        <div className="mt-6 flex justify-center gap-3">
          <button
            ...
            aria-busy={busy}
            onClick={() => decide(true)}
            className="min-h-11 flex-1 rounded-md bg-primary px-4 text-sm font-semibold text-primary-foreground transition hover:bg-primary/90 disabled:opacity-60"
          >
            Approve
          </button>
          <button
            ...
            className="min-h-11 flex-1 rounded-md border border-white/10 bg-white/[0.04] px-4 text-sm font-medium text-foreground transition hover:bg-white/[0.08] disabled:opacity-60"
          >
            Deny
          </button>
        </div>

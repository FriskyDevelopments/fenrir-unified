...
export const GATE_PRESETS: GatePreset[] = [
  ...
  },
  {
    ...
    overlay: "linear-gradient(180deg, oklch(0.18 0.02 65 / 74%), oklch(0.14 0.015 70 / 94%))",
    thumb:
...
// Images are limited to formats the content-verification service can screen.
export const GATE_MEDIA_TYPE_PATTERN = /^(image\/(png|jpeg|webp|gif)|video\/(mp4|webm|quicktime))$/;

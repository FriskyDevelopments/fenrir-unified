...
1. Start the local development server:
   ...
   ```
2. Ensure you have a valid local session (e.g., mock auth or a real Supabase sign-in).
...
*Note: If the `NEON_DATABASE_URL` is missing locally, the API will return a mocked response for safe UI testing. Check your console logs for the fallback warning.*

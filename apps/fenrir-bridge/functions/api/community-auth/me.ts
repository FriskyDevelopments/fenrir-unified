import { communityAuthConfigured, communityAuthNotConfigured, getCommunityMembershipForUser, communitySql, readCommunitySession } from "../../_lib/community-auth";
...
export async function onRequestGet(context: any) {
  ...
  const membership = await getCommunityMembershipForUser(sql, session.user_id, session.community_org_id ?? null);
